...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="absolute left-4 md:left-[110px] top-[479px] md:top-[405px] z-10">
        <p className="font-['Dancing_Script'] font-bold text-brand-linen text-[60px] leading-[1.2] tracking-[1.2px]">
          Mariana & Martín
        </p>
        <p className="font-['Dancing_Script'] font-bold text-brand-linen text-[56px] leading-[1.2] tracking-[1.12px]">
          25 de abril de 2026
        </p>
      </div>
    </section>
